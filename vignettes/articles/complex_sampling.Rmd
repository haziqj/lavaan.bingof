...
```{r strat_Sigma}
lavaan.bingof:::create_Sigma2_matrix_complex(fit21, svy1) |>
  corrplot(is.corr = FALSE, method = "color", tl.col = "black", 
           col = viridis::viridis(100), addCoef.col = "grey50", 
           number.cex = 0.5)
```
...
```{r clust_Sigma}
lavaan.bingof:::create_Sigma2_matrix_complex(fit22, svy2) |>
  corrplot(is.corr = FALSE, method = "color", tl.col = "black", 
           col = viridis::viridis(100), addCoef.col = "grey50", 
           number.cex = 0.5)
```
...
```{r strcl_Sigma}
lavaan.bingof:::create_Sigma2_matrix_complex(fit23, svy3) |>
  corrplot(is.corr = FALSE, method = "color", tl.col = "black", 
           col = viridis::viridis(100), addCoef.col = "grey50", 
           number.cex = 0.5)
```
