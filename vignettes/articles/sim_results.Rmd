...
```{r srs_type1a, fig.width = 8, fig.height = 5.5}
...
```{r srs_type1b, fig.width = 8, fig.height = 5.5}
...
```{r srs_type1c, fig.width = 8, fig.height = 5.5}
...
```{r srs_powerd, fig.width = 8, fig.height = 5.5}
...
```{r srs_powere, fig.width = 8, fig.height = 5.5}
...
```{r srs_powerf, fig.width = 8, fig.height = 5.5}
...
```{r complex_type1a, fig.width = 8, fig.height = 5.5}
p_complex_a #+   theme(legend.position = c(0.85, 0.15))
```

### 5% significance {.active}

```{r complex_type1b, fig.width = 8, fig.height = 5.5}
p_complex_b #+   theme(legend.position = c(0.85, 0.15))
```

### 1% significance

```{r complex_type1c, fig.width = 8, fig.height = 5.5}
...
```{r complex_powerd, fig.width = 8, fig.height = 5.5}
...
```{r complex_powere, fig.width = 8, fig.height = 5.5}
...
```{r complex_powerf, fig.width = 8, fig.height = 5.5}
