...
save(res_srs_type1, file = "res_srs_type1.rda")
save(res_srs_power, file = "res_srs_power.rda")
...
save(res_complex_type1, file = "res_complex_type1.rda")
save(res_complex_power, file = "res_complex_power.rda")
